...
def LogisticRegressionPCA(X, y):
	...
	# use logistic regression model to fit the data.
	...
	print('TRAIN SCORE', logistic_regression.score(X_train_pca, y_train))
	print('TEST SCORE', logistic_regression.score(X_test_pca, y_test))
